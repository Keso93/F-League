...
class LocationRepository extends AbstractRepository
{
    ...
    public function mergeLocation(Location $location)
    {
        $this->_em->merge($location);
        $this->_em->flush();

        return $location;
    }

    public function deleteLocation(Location $detachedLocation)
    {
        $location = $this->_em->merge($detachedLocation);
